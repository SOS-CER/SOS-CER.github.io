...
description: CSC216 Lab 10 - Deployment
navigation: on
pagegroup: 10-lab
---

# CSC216 Lab 10 Deployment
{% include iconHeader.html type="deployment" %}
When you deploy your software, you release it to your customer.  For CSC216, that means your work is ready for evaluation by the teaching staff.  We will evaluate your work against the [Lab 10 rubric](#lab-rubric).  As you compare your submission against the rubric and make your final push to GitHub, you should complete these final checks:
...
To generate Javadoc, you need to [configure and run the Javadoc tool](../../gp1/gp1-javadoc.md#configure-and-run-javadoc-for-your-project), [fix Javadoc errors and warnings](../../gp1/gp1-javadoc.md#fix-javadoc-errors-and-warnings), and [check the generated Javadoc pages](../../gp1/gp1-javadoc.md#check-generated-javadoc-pages).  Make sure you push your changes to GitHub!
{% endcapture %}
