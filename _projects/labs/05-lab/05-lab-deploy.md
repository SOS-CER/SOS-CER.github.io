...
description: CSC216 Lab 05 - Deployment
navigation: on
pagegroup: 05-lab
---
# CSC216 Lab 05: Deployment
{% include iconHeader.html type="deployment" %}
When you deploy your software, you release it to your customer.  For CSC216, that means your work is ready for evaluation by the teaching staff.  We will evaluate your work against the [Lab 05 rubric](#lab-rubric).  As you compare your submission against the rubric and make your final push to GitHub, you should complete these final checks:

  * You have met the [requirements](05-lab-requirements) and [design](05-lab-design) for the [Lab 05 `PackScheduler`](../05-lab) project.
...
{% endcapture %}
{% include callout.html content=callout_content icon="ciTool" type="reminder" title="Reminder: Intepreting Jenkins" %}
