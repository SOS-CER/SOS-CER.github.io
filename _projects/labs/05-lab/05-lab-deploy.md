...
description: CSC 217 Lab 05 - Deployment
navigation: on
pagegroup: 05-lab
---
# CSC 217 Lab 05: Deployment
{% include iconHeader.html type="deployment" %}
When you deploy your software, you release it to your customer.  For CSC 217, that means your work is ready for evaluation by the teaching staff.  We will evaluate your work against the [Lab 05 rubric](#lab-rubric).  As you compare your submission against the rubric and make your final push to GitHub, you should complete these final checks:
