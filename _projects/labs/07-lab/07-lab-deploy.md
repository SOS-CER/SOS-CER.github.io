...
description: CSC216 Lab 07 - Deployment
navigation: on
pagegroup: 07-lab
---

# CSC216 Lab 07 Deployment
{% include iconHeader.html type="deploy" %}
When you deploy your software, you release it to your customer.  For CSC216, that means your work is ready for evaluation by the teaching staff.  We will evaluate your work against the [Lab 07 rubric](#lab-rubric).  As you compare your submission against the rubric and make your final push to GitHub, you should complete these final checks:
