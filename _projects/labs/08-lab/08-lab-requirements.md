...
description: CSC 217 Lab 08 - Requirements
navigation: on
pagegroup: 08-lab
---
# CSC 217 Lab 08 Requirements
...
<font color="red">For Lab 08, you will focus on the course roll functionality, which are described in</font> [[UC12]](#uc12), [[UC13]](#uc13), [[UC14]](#uc14), [[UC15]](#uc15), [[UC16]](#uc16), and [[UC17]](#uc17)<font color="red">.  To properly implement course roll functionality, a course needs an enrollment capacity.    There are changes to the</font> [[Course Records Data Format]](#course-records) <font color="red">to support this functionality.</font>
...
#### Main Flow
  ...
  1. The registrar enters information about a new course in the *Course Information* portion of the user interface **[[Course Records Data Format]](#course-records)** and clicks **Add Course** button.
	 ...
	 * <font color="red">enrollment capacity</font> **[[Invalid Enrollment Capacity]](#uc10-invalidenrollmentcap)**
...
#### Alternative Flows
  ...
  * <a id="uc10-invalidenrollmentcap"></a>**[Invalid Instructor ID]**: <font color="red">If the course's enrollment capacity is invalid</font> **[[Invalid Course Records]](#invalid-course-records)**, <font color="red">the error message "Invalid instructor unity id" is displayed.  The user clicks OK and is returned to the course catalog display.</font>
...
#### Main Flow
  ...
  4. <font color="red">The student is added to the course's roll.</font> [[Already Enrolled]](#uc14-a3)[[Course Full]](#uc14-a4)
...
#### Alternative Flows
  ...
  * <a id="uc14-a3"></a> **[Already Enrolled]**: <font color="red">If the student is already enrolled in the course (i.e., on the course roll), a pop-up message stating "Course cannot be added to schedule." is displayed. The student clicks OK and is returned to their schedule with no change.</font>
  * <a id="uc14-a4"></a> **[Course Full]**: <font color="red">If the course is full (meaning the course has reached capacity), a pop-up message stating "The course cannot be added" is displayed. The student clicks OK and is returned to their schedule with no change.</font>
...
#### Main Flow
  ...
  4. <font color="red">The student is removed from the course's roll.</font>
...
A course has a course name, course title, section number, number of credit hours, instructor's unity id, <font color="red">enrollment capacity,</font> meeting days, start time, and end time. When stored in a text file, a course record is a comma separated list in the following format:
