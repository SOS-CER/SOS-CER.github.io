...
description: CSC216 Lab 08 - Requirements
navigation: on
pagegroup: 08-lab
---
# CSC216 Lab 08 Requirements
...
<font color="red">For Lab 08, you will focus on the course roll functionality, which is described in</font> [[UC6]](#uc6)<font color="red">.  In order for you to properly implement course roll functionality, a course needs an enrollment capacity.  There are changes to</font> [[UC5]](#uc5) <font color="red">to support this functionality.</font>
...
**Main Flow:** Every course has a course name, course title, section number, number of credit hours, instructor's unity id, <font color="red">enrollment capacity,</font> meeting days, start time, and end time. [[S1]](#uc5-s1). When stored in a text file, a course record is a comma separated list in the following format:
...
**Sub Flows:**
  ...
  * <a id="uc5-s1"></a>[S1]: Information about scheduled courses are stored in a file with one course record per line.  A course record is a comma separated list of the course name, course title, section number, the number of credit hours, instructor's unity id, <font color="red">enrollment capacity,</font> meeting days, start time, and end time.  The start time and end time may be omitted if the meeting days are listed as 'A'(rranged).  Valid course records are stored in a list of courses [[E1]](#uc5-e1).  An example of what a course schedule file might look like is below:
...
**Alternative Flows:**
  ...
  * <a id="uc5-e1"></a>[E1] An invalid course record is ignored and not added to the list of courses stored by the system. A course record is invalid if one or more of the following are true, and an invalid course records is skipped:
     ...
     * <font color="red">the enrollment capacity is less than 10 or greater than 250</font>
...
**Sub Flows:**
  ...
  * <a id="uc6-s2"></a>[S2]: All courses are listed.  The student can select a course and add the course to their schedule [[E2]](#uc6-e2)[[E3]](#uc6-e3).  <font color="red">The student is added to the course's roll </font>[[E5]](#uc6-e5)[[E6]](#uc6-e6).
  * <a id="uc6-s3"></a>[S3]: The student selects a course from their schedule and clicks **Remove Course**.  The course is removed from the schedule [[E4]](#uc6-e4) <font color="red"> and the student is removed from the course roll</font>.
  * <a id="uc6-s4"></a>[S4]: The student clicks **Reset Schedule**.  All courses are removed from the schedule.  The student is removed from each of those courses. The schedule's name is reset.
...
**Alternative Flows:**
  ...
  * <font color="red"><a id="uc6-e5"></a>[E5]: If the student is already enrolled in the course (i.e., on the course roll), a pop-up message stating "Course cannot be added to schedule." is displayed. The student clicks OK and is returned to their schedule with no change.</font>
  * <font color="red"><a id="uc6-e6"></a>[E6]: If the course is full (meaning the course has reached capacity), a pop-up message stating "The course cannot be added" is displayed.  The student clicks OK and is returned to their schedule with no change.</font>
