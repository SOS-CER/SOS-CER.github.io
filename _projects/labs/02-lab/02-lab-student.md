...
There are several resources provided for writing tests, including sample test code:
  ...
  * [Guided Project 1 CourseTest.java](https://pages.github.ncsu.edu/engr-csc216-staff/CSC216-SE-Materials/gp1/files/CourseTest.java)
...
Use the [Guided Project 1 CourseTest.testEquals() and CourseTest.testHashCode()](https://pages.github.ncsu.edu/engr-csc216-staff/CSC216-SE-Materials/gp1/files/CourseTest.java) method as guides for writing your tests for `equals()` and `hashCode()`.
