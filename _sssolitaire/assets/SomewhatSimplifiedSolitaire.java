...
/**
 * This program implements the Somewhat Simplified Solitaire Encryption and
 ...
 *
 */
public class SomewhatSimplifiedSolitaire {

    /**
     * Joker A is represented by the number 27
     */
    public static final String JOKER_A = "27";

    /**
     * Joker B is represented by the number 28
     */
    public static final String JOKER_B = "28";
    ...
    public static String moveSecondJokerDownTwo(String deck) {
        ...
        if (indexOfJokerB < deck.substring(0, deck.lastIndexOf(" ")).lastIndexOf(" ")) {
            String firstHalfOfDeck = deck.substring(0, indexOfJokerB);
            ...
            String secondCardInSecondHalf = secondHalfOfDeckWithoutFirstCard.substring(0,
                    secondHalfOfDeckWithoutFirstCard.indexOf(" ") + 1);
     ...
     * is a joker, let its value be 27, regardless of which joker it is.) Take that
    ...
    /**
     * Look at the top card's value (which is again 1-27, as it was in the previous
     ...
     * from the deck. If that next card happens to be a joker, return "invalid".
     * 
     * @param deck
     *            current deck
     * @return the next keystream value
